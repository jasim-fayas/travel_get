...
<form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
  <table width="465" height="602" border="1">
    <tr>
      ...
      <input type="text" name="txt_firstname" id="txt_firstname" required title="Name Allows Only Alphabets,Spaces and First Letter Must Be Capital Letter" pattern="^[A-Z]+[a-zA-Z ]*$" /></td>
    </tr>
    <tr>
      <td width="201">Last name</td>
      <td width="248"><label for="txt_lastname"></label>
      <input type="text" name="txt_lastname" id="txt_lastname" required title="Name Allows Only Alphabets,Spaces and First Letter Must Be Capital Letter" pattern="^[A-Z]+[a-zA-Z ]*$" /></td>
    </tr>
    <tr>
      <td>Contact</td>
    ...
    <tr>
      ...
      <textarea name="txt_address" id="txt_address" required cols="45" rows="5"></textarea></td>
    </tr>
    <tr>
      <td>Gender</td>
      <td><input type="radio" name="rad_gender" id="txt_male" value="Male" required />
        Male
    ...
    <tr>
      ...
      <textarea name="txt_experience" required id="txt_experience" cols="45" rows="5"></textarea></td>
    </tr>
    <tr>
      <td>Password</td>
      <td><label for="txt_password"></label>
      <input type="password"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required name="txt_password" /></td>
    </tr>
    <tr>
      <td>District</td>
