...
if(isset($_GET["promo"]))
		{
			...
			$data123=$data12->fetch_assoc(); 
			 ...
			 $ratewithoutpromo=$data123['package_rate']*$count;
			   ...
			   $finalrate1= $ratewithoutpromo - $ratewithpromo;
		}
...
$bid1=$row["id"];
		    ...
		    header("location:Amount.php?count=".$_GET["count"]."&promo=".urlencode($promocode_name) . "&bid1=" . urlencode($bid1) . "&amount=" . urlencode($finalrate));
			exit();
...
<form method="post">
    <tr>
      ...
      <input type="text" name="txt_promo" value="If you dont have promote code please click the submit button" style="opacity: 0.4;" id="txt_promo" /></td>
