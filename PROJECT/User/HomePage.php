        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                ...
                <li class="nav-item active"><a href="../index.php" class="nav-link">Home</a></li>
                    ...
                    <li class="nav-item"><a href="SearchPackage.php" class="nav-link">Search Package</a></li>
                ...
                <div class="col-md-6 order-md-last heading-section pl-md-5 ftco-animate d-flex align-items-center">
                    <div class="w-100">>
                        ...
                        <p>In 2023 kerala was listed at the 13th spot in the 'New York Times' annual list of places
                           ...
                           <p> <a href="SearchPackage.php" class="btn btn-primary py-3 px-4">Search Destination</a></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row">
